<?php $__env->startSection('breadcrumb'); ?>
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="<?php echo e(URL::to('sub-menu',$subMenu->fk_menu_id)); ?>">Sub Menu</a>
        </li>
        <li class="breadcrumb-item">
            <a>Sub Sub Menu</a>
        </li>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header card-info">
                    Sub Sub Menu of <u><?php echo e($subMenu->name); ?></u>
                    <div class="card-btn pull-right">
                        <a href="<?php echo e(route('menu.index')); ?>" class="btn btn-primary"> <i class="fa fa-list"></i> All Module </a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="menu_form left">
                        <?php echo Form::open(array('route' => 'sub-sub-menu.store','class'=>'form-horizontal','files'=>true)); ?>
                        ...
                        <input type="hidden" name="fk_sub_menu_id" value="<?php echo e($subMenu->id); ?>">
                        <input type="hidden" name="fk_menu_id" value="<?php echo e($subMenu->fk_menu_id); ?>">
                        <div class="form-group row">
                    ...
                    <table class="table table-striped table-hover table-bordered center_table" id="my_table">
                        ...
                        <?php $__currentLoopData = $allData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><a href="<?php echo e(url('sub-menu',$menu->id)); ?>" class="label label-primary" style="color: #fff;"><?php echo e($data->sub_menu_name); ?></a></td>
                                <?php if(!isset($subMenu)): ?>
                                ...
                                <td>
                                    <a href="#editModal<?php echo e($data->id); ?>" data-toggle="modal" class="btn btn-xs btn-info action_btn"><i class="fa fa-edit"></i></a>
                                    <!-- Modal -->
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Edit Sub Sub Menu : <b> <?php echo e($data->name); ?> </b></h4>
                                                </div>
                                                <?php echo Form::open(array('route' => ['sub-sub-menu.update', $data->id],'method'=>'PUT','class'=>'form-horizontal','files'=>true)); ?>
                        ...
                        <strong><?php echo e($errors->first('url')); ?></strong>
                                    ...
                                    <?php echo Form::open(array('route' => ['sub-sub-menu.destroy',$data->id],'method'=>'DELETE','class'=>'deleteForm','id'=>"deleteForm$data->id")); ?>

                                    <button type="button" class="btn btn-xs btn-danger action_btn"  onclick='return deleteConfirm("deleteForm<?php echo e($data->id); ?>")'><i class="fa fa-trash"></i></button>
                                    <?php echo Form::close(); ?>
