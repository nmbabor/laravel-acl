...
$(document).ready(function() {
    ...
    ! function() {
        o = "" != t("NavbarBackground") ? t("NavbarBackground") : o, n = "" != t("header-theme") ? t("header-theme") : n, r = "" != t("menu-title-theme") ? t("menu-title-theme") : r, d = "" != t("themebg-pattern") ? t("themebg-pattern") : d, i = "" != t("active-item-theme") ? t("active-item-theme") : i, c = "" != t("fream-type") ? t("fream-type") : c, l = "" != t("layoutlayout") ? t("layoutlayout") : l, h = "" != t("vertical-layout") ? t("vertical-layout") : h, m = "" != t("vertical-effect") ? t("vertical-effect") : m, p = "" != t("menu-icon-style") ? t("menu-icon-style") : p
            ...
            verticalMenulayout: h,
            MenuTrigger: "click",
            SubMenuTrigger: "click",
            activeMenuClass: "active",
            ThemeBackgroundPattern: d,
            HeaderBackground: n,
            LHeaderBackground: r,
            NavbarBackground: o,
            ActiveItemBackground: i,
        ...
        function() {
            $(".theme-color > a.Layout-type").on("click", function() {
                ...
                $(".pcoded").attr("layout-type", t), e("layoutlayout", t, a), "dark" == t && ($(".pcoded-header").attr("header-theme", "theme1"), $(".pcoded-navbar").attr("navbar-theme", "theme1"), $(".pcoded-navbar").attr("active-item-theme", "theme1"), $(".pcoded").attr("fream-type", "theme1"), $("body").addClass("dark"), $("body").attr("themebg-pattern", "theme1"), $(".pcoded-navigation-label").attr("menu-title-theme", "theme9"), e("header-theme", "theme1", a), e("NavbarBackground", "theme1", a), e("menu-title-theme", "theme1", a), e("themebg-pattern", "theme1", a), e("fream-type", "theme1", a), e("active-item-theme", "theme1", a)), "light" == t && ($(".pcoded-header").attr("header-theme", "theme1"), $(".pcoded-navbar").attr("navbar-theme", "themelight1"), $(".pcoded-navigation-label").attr("menu-title-theme", "theme1"), $(".pcoded-navbar").attr("active-item-theme", "theme1"), $(".pcoded").attr("fream-type", "theme1"), $("body").removeClass("dark"), $("body").attr("themebg-pattern", "theme1"), e("header-theme", "theme1", a), e("NavbarBackground", "themelight1", a), e("menu-title-theme", "theme1", a), e("themebg-pattern", "theme1", a), e("fream-type", "theme1", a), e("active-item-theme", "theme1", a)), "reset" == t && (e("NavbarBackground", null, 0), e("header-theme", null, 0), e("menu-title-theme", null, 0), e("themebg-pattern", null, 0), e("active-item-theme", null, 0), e("fream-type", null, 0), e("layoutlayout", null, 0), e("vertical-layout", null, 0), e("vertical-effect", null, 0), location.reload())
            })
        }(),
        function() {
        ...
        function() {
            $(".theme-color > a.header-theme").on("click", function() {
                var t = $(this).attr("header-theme"),
                    o = $(this).attr("active-item-color");
