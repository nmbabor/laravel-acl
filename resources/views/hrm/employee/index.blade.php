                    ...
                    <div class="card">
                        <div class="card-header card-info">
                            ...
                            <div class="card-heading-btn pull-right">
                                ...
                                <a class="btn btn-primary btn-sm" href="{{URL::to('export-employee')}}" data-toggle="modal" data-target="#exportEmployee"> <i class="fa fa-file-excel-o"></i> Export </a>
                                <a class="btn btn-primary btn-sm" href="{{URL::to('/employees/create')}}"> <i class="fa fa-plus-circle"></i> Add New Employee </a>
                        ...
                        <div class="modal fade" id="exportEmployee" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    {!! Form::open(['url'=>'export-employee','method'=>'GET','files'=>true]) !!}
