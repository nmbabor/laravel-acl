        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header card-info">
                    <i class="fa fa-edit"></i> Edit old terms & conditions
                    <div class="card-btn pull-right">
                        <a href="{{URL::to('company-terms-conditions')}}" class="btn btn-primary btn-sm" > <i class="fa fa-list"></i> View All</a>
                    </div>
                </div>

                {!! Form::open(array('route' =>['company-terms-conditions.update',$getTermsConditionsById->id],'method'=>'PUT','class'=>'form-horizontal','files'=>true)) !!}
                <div class="card-body">
                    ...
                    <div class="form-group row  {{ $errors->has('condition_type') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-8">
                            {{Form::select('condition_type',['1'=>'Purchase Order','2'=>'Purchase Return','3'=>'Sales','4'=>'Sales Return','5'=>'HR','6'=>'Payroll','7'=>'Transfer Item'],$getTermsConditionsById->condition_type,['id'=>'companyId','class'=>'form-control','required'=>true,'placeholder'=>'Select one'])}}
                    ...
                    <div class="form-group row  {{ $errors->has('condition_title') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-8">
                            {{Form::text('condition_title',$value=$getTermsConditionsById->condition_title,['class'=>'form-control'])}}
                    ...
                    <div class="form-group row  {{ $errors->has('condition_details') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-8">
                            {{Form::textarea('condition_details',$value=$getTermsConditionsById->condition_details,['class'=>'form-control tinymce','rows'=>'4'])}}
                    ...
                    <div class="form-group row  {{ $errors->has('condition_status') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-8">
                            {{Form::select('condition_status',['1'=>'Active','0'=>'Inactive'],$getTermsConditionsById->condition_status,['class'=>'form-control','required'=>true])}}
