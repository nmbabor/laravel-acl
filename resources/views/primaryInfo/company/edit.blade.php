    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                {!! Form::open(array('route' =>['company.update', $data->id],'method'=>'PUT','class'=>'form-horizontal','files'=>true)) !!}
                <div class="card-body">
                    ...
                    <div class="form-group row  {{ $errors->has('shipping_address') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-8">
                            {{Form::text('shipping_address',$data->shipping_address,array('class'=>'form-control','placeholder'=>'Shipping Address'))}}
                    ...
                    <div class="form-group  row {{ $errors->has('modules') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-8">
                            {{Form::select('modules[]',$modules,$data->modules->pluck('module_id'),['class'=>'form-control select','multiple','required'])}}
