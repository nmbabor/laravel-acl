...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="{{URL::to('inventory-item')}}">Item</a>
        </li>
    </ul>
@endsection
@section('content')
    <div class="row ">
        <div class="col-lg-12">
            <div class="card ">
                ...
                {!! Form::open(array('route' =>'inventory-item.store','method'=>'POST','class'=>'form-horizontals','files'=>true)) !!}
                <div class="card-body">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row">
                            <div class="col-xs-12 col-sm-8 col-md-8">
                                ...
                                {{Form::text('item_name',$value=old('item_name'),['class'=>'form-control','required'=>true])}}
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                ...
                                <div class="">
                                    {{Form::text('item_code',$value=old('item_code'),['class'=>'form-control','placeholder'=>'Auto Generate','readonly'=>true])}}
                                    <span class="text-danger">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                ...
                                <div class="">
                                    {{Form::select('category_id',$categories,[],['class'=>'form-control select','placeholder'=>'Select'])}}
                                    <span class="text-danger">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <label>Brand</label>
                                <div class="">
                                    {{Form::select('brand_id',$brands,[],['class'=>'form-control select','placeholder'=>'Select'])}}
                                    <span class="text-danger">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                               ...
                               <div class="">
                                   {{Form::select('item_unite_id',$unites,[],['class'=>'form-control select','placeholder'=>'Select','required'=>true])}}
                                   <span class="text-danger">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                ...
                                <div class="">
                                    {{Form::number('cost_price',$value=old('cost_price'),['min'=>0,'class'=>'form-control'])}}
                                    <span class="text-danger">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                               ...
                               <div class="">
                                   {{Form::number('sale_price',$value=old('sale_price'),['min'=>0,'class'=>'form-control'])}}
                                   <span class="text-danger">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                               ...
                               <div class="">
                                   {{Form::number('reorder_level',$value=old('reorder_level'),['min'=>0,'class'=>'form-control'])}}
                                   <span class="text-danger">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                               ...
                               <div class="">
                                   {{Form::color('item_color',$value=old('item_color'),['class'=>'form-control'])}}
                                   <span class="text-danger">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="">
                                    {{Form::textarea('item_details',$value=old('item_details'),['class'=>'form-control','rows'=>4])}}
                                    <span class="text-danger">
