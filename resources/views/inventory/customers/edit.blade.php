        ...
        <div class="col-lg-12">
            <div class="card ">
                <div class="card-header card-info">
                   <i class="fa fa-edit"></i> Edit old customer info
                ...
                {!! Form::open(array('route' =>['inventory-customer.update',$getCustomerById->id],'method'=>'PUT','class'=>'form-horizontals','files'=>true)) !!}
                <div class="card-body">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row">
                            <div class="col-xs-12 col-sm-3 col-md-3">
                                ...
                                {{Form::text('customer_name',$value=$getCustomerById->customer_name,['class'=>'form-control','required'=>true])}}
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                ...
                                <div class="">
                                    {{Form::text('customer_id',$value=$getCustomerById->customer_id,['class'=>'form-control','placeholder'=>'Auto Generate','readonly'=>true,'disable'=>true])}}
                                    <span class="text-danger">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                ...
                                <div class="">
                                    {{Form::select('customer_type',['1'=>'General Customer','2'=>'Special Customer'],$getCustomerById->customer_type,['class'=>'form-control','placeholder'=>'Select one','required'=>true])}}
                                    <span class="text-danger">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                ...
                                <div class="">
                                    {{Form::select('religion',['Muslim'=>'Muslim','Hindo'=>'Hindo','Bodish'=>'Bodish','krishna'=>'krishna','Other'=>'Other'],$getCustomerById->religion,['class'=>'form-control','placeholder'=>'Select'])}}
                                    <span class="text-danger">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="">
                                    {{Form::textarea('present_address',$value=$getCustomerById->present_address,['class'=>'form-control','rows'=>3])}}
                                    <span class="text-danger">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="">
                                    {{Form::textarea('permanent_address',$value=$getCustomerById->permanent_address,['class'=>'form-control','rows'=>3])}}
                                    <span class="text-danger">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row">
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                ...
                                {{Form::number('mobile',$value=$getCustomerById->mobile,['class'=>'form-control','required'=>true])}}
                                <span class="text-danger">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <label>Phone</label>
                                {{Form::text('phone',$value=$getCustomerById->phone,['class'=>'form-control'])}}
                                <span class="text-danger">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <label>Email</label>
                                {{Form::email('email',$value=$getCustomerById->email,['class'=>'form-control'])}}
                                <span class="text-danger">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                ...
                                {{Form::text('facebook',$value=$getCustomerById->facebook,['class'=>'form-control'])}}
                                <span class="text-danger">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                ...
                                {{Form::text('nit_no',$value=$getCustomerById->nit_no,['class'=>'form-control'])}}
                                <span class="text-danger">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <label>City</label>
                                {{Form::text('city',$value=$getCustomerById->city,['class'=>'form-control'])}}
                                <span class="text-danger">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <label>Region</label>
                                {{Form::text('region',$value=$getCustomerById->region,['class'=>'form-control'])}}
                                <span class="text-danger">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                ...
                                {{Form::text('zip_code',$value=$getCustomerById->zip_code,['class'=>'form-control'])}}
                                <span class="text-danger">
                        ...
                        <div class="form-group row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="">
                                    {{Form::textarea('shipping_address',$value=$getCustomerById->shipping_address,['class'=>'form-control','rows'=>3])}}
                                    <span class="text-danger">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="">
                                    <label class="slide_upload"  for="customerImg">
                                        @if($getCustomerById->customer_img)
                                            <img id="customer_img_load" src="{{asset($getCustomerById->customer_img)}}" width="150" height="120" title="Customer Image">
                                            @else
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <label>Status</label>
                                <div class="">
                                    {{Form::select('status',['1'=>'Active','0'=>'Inactive'],$getCustomerById->status,['class'=>'form-control','required'=>true])}}
                                </div>
                                <span class="text-danger">
