    ...
    <div class="row ">
        <div class="col-lg-12">
            <div class="card ">
                ...
                {!! Form::open(array('route' =>'inventory-purchase-order.store','method'=>'POST','class'=>'form-horizontals','files'=>true)) !!}
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                            <div class="">
                                ...
                                <div>
                                    {{Form::select('vendor_id',$vendors,[],['class'=>'form-control select','placeholder'=>'Select','required'=>true])}}
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                ...
                                @if(!empty($lastPurchaseOrderId))
                                    <div>
                                        {{Form::text('purchase_order_no',$value=date('Ymds').'PON'.(1000+$lastPurchaseOrderId),['class'=>'form-control','required'=>true,'readonly'=>true])}}
                                        <span class="text-danger">
                                ...
                                @else
                                    <div>
                                        {{Form::text('purchase_order_no',$value=date('Ymds').'PON'.'1000',['class'=>'form-control','required'=>true,'readonly'=>true])}}
                                        <span class="text-danger">
                                                {{$errors->has('purchase_order_no')?$errors->first('purchase_order_no'):''}}
                                            </span>
                                    </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                ...
                                <div>
                                    {{Form::text('date_of_purchase_order',$value=date('d-m-Y'),['class'=>'form-control datepicker','required'=>true])}}
                                    <span class="text-danger">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                ...
                                <div>
                                    {{Form::text('date_of_shipment',$value=date('d-m-Y'),['class'=>'form-control datepicker','required'=>true])}}
                                    <span class="text-danger">
                    ...
                    <div class="form-group row">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="">
                                {{Form::textarea('billing_address',$value=old('billing_address'),['class'=>'form-control','required'=>true,'rows'=>2])}}
                                <span class="text-danger">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="">
                                {{Form::textarea('shipping_address',$value=old('shipping_address'),['class'=>'form-control','required'=>true,'rows'=>2])}}
                                <span class="text-danger">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered" id="auto_table">
                                ...
                                <tr>
                                    <td>
                                        <input type="text"  id="itemName_1" class="form-control" autocomplete="off" onclick="autoCompleteItemSearch(this.id)" placeholder="Type item" required>
                                        <input type="hidden" name="inventory_item_id[]" id="hideId_1">
                                    </td>
                                    <td>
                                        <input type="number" name="item_order_qty[]"  value="1" id="itemQty_1"  onkeyup="qtyXItemPrice(this.id)" onkeyup="totalOrderedQty()" min="0" class="form-control itemQty">
                                    </td>
                                    <td>
                                        <input type="number" name="item_price[]" value="" id="itemPrice_1"  onkeyup="itemTotal(this.id)" onkeydown="totalOrderedQty()" min="0" class="form-control itemPrice" required>
                                    </td>
                                    <td>
                                        <input type="number" name="item_total[]" value="" id="itemTotal_1" min="0" class="form-control itemTotal" readonly required>
                                    </td>
                                    <td>
                                            <span style="cursor: pointer" class="delete-row" id="deleteRow_1"><i class="fa fa-trash text-danger" title="Delete Product"></i>
                                            </span>
                                    </td>
                                </tr>
                        ...
                        <div class="col-md-7">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div>
                                        {{Form::textarea('item_specification',$value=old('item_specification'),['class'=>'form-control','rows'=>4]) }}
                                    </div>
                                </div>
                                <div class="col-md-12" >
                                    ...
                                    <div style="border: 1px solid #c0c0c0;padding: 5px">
                                        ...
                                        @foreach($termsConditions as $key => $value)
                                            <label >{{Form::checkbox('terms_conditions_id[]',$key) }} {{$value}}</label>
                                        @endforeach
                                    </div>
                                </div>
                            </div><!--end row-->
                        ...
                        <div class="col-md-5">
                            <table class="table table-bordered amount-summery" style="background-color: #ffffff;margin-top: 10px">
                                ...
                                <tr>
                                    ...
                                    <th width="60">
                                        <input type="number" name="sub_total" value="" id="sub_total" min="0" class="form-control">
                                        <input type="hidden" name="order_qty" value="" id="totalOrderQty">
                                    </th>
                                </tr>
                                {{--<tr>
                                    <th width="40"> <b>Shipping Charge</b></th>
                                    <th width="60"><input type="number" name="shipping_charge" value="" id="shipping_charg" min="0" class="form-control balanceChange"></th>
                                </tr>--}}
                                <tr>
                                    <th width="40"> <b>Gtand Total</b></th>
                                    <th width="60"><input type="number" name="grand_total" value="" id="total_amount" min="0" class="form-control"></th>
                                </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <script>
        $(document).on('click','#addMoreItem',function () {
            ...
            var htmltr='<tr>\n' +
                ...
                '                                            <input type="hidden" name="inventory_item_id[]" id="hideId_'+i+'">'+
                '                                        </td>\n' +
                '                                        <td>\n' +
                '                                            <input type="number" name="item_order_qty[]"  value="1" id="itemQty_'+i+'"   onkeyup="qtyXItemPrice(this.id)" onkeyup="totalOrderedQty()" min="0" class="form-control itemQty">\n' +
                '                                        </td>\n' +
                '                                        <td>\n' +
                '                                            <input type="number" name="item_price[]" value="" id="itemPrice_'+i+'"  onkeyup="itemTotal(this.id)" onkeydown="totalOrderedQty()" min="0" class="form-control itemPrice" required>\n' +
                '                                        </td>\n' +
                '                                        <td>\n' +
                '                                            <input type="number" name="item_total[]" value="" id="itemTotal_'+i+'" min="0" class="form-control itemTotal" readonly required>\n' +
                '                                        </td>\n' +
                '                                        <td>\n' +
