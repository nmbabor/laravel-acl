	...
	<div class="row ">
		<div class="col-lg-12">
			<div class="card ">
				...
				{!! Form::open(array('route' =>'inventory-vendor.store','method'=>'POST','class'=>'form-horizontals','files'=>true)) !!}
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-md-4 col-sm-4">
							<div class="radio">
								<label>
									<input type="radio" name="vendor_is" class="vendor-is" value="1" id="radio-required" required checked> Company
								</label>
							</div>
						</div>
						<div class="col-md-4 col-sm-4">
							<div class="radio">
								<label>
									<input type="radio" name="vendor_is" class="vendor-is" value="2" id="radio-required2" required> Person
								</label>
							</div>
						</div>
					...
					<fieldset>
						...
						<div class="form-group row">
							<div class="col-xs-12 col-sm-3 col-md-3">
								...
								{{Form::text('vendor_name',$value=old('vendor_name'),['class'=>'form-control','required'=>true])}}
							...
							<div class="col-xs-12 col-sm-6 col-md-3">
								...
								<div class="">
									{{Form::text('vendorid',$value=old('vendorid'),['class'=>'form-control','placeholder'=>'Auto Generate','readonly'=>true,'disable'=>true])}}
									<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								<div class="">
									{{Form::select('vendor_type',['1'=>'General Vendor','2'=>'Special Vendor'],[],['class'=>'form-control','placeholder'=>'Select one','required'=>true])}}
									<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								<div class="">
									{{Form::select('category_id',$categories,[],['class'=>'form-control js-example-data-array select2-hidden-accessible','placeholder'=>'Select one'])}}
									<span class="text-danger">
						...
						<div class="form-group row">
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								<div class="">
									{{Form::text('nid_no',$value=old('nid_no'),['class'=>'form-control'])}}
									<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								<div class="">
									{{Form::text('trade_licence_no',$value=old('trade_licence_no'),['class'=>'form-control'])}}
									<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								<label>Vat Id</label>
								<div class="">
									{{Form::text('vat_id',$value=old('vat_id'),['class'=>'form-control'])}}
									<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								<div class="">
									{{Form::text('income_tax_id',$value=old('income_tax_id'),['class'=>'form-control'])}}
									<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								<div class="">
									<label class="upload_photo"  for="vendorNidFile">
										<img id="vendor_nid_img_load" src="{{asset('images/default/photo.png')}}" ><i class="upload_hover ion ion-ios-camera-outline"></i>
									</label>
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								<div class="">
									<label class="upload_photo"  for="vendorTinFile">
										<img id="vendor_tin_img_load" src="{{asset('images/default/photo.png')}}" ><i class="upload_hover ion ion-ios-camera-outline"></i>
									</label>
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								<div class="">
									<label class="upload_photo"  for="vendorVatFile">
										<img id="vendor_vat_img_load" src="{{asset('images/default/photo.png')}}" ><i class="upload_hover ion ion-ios-camera-outline"></i>
									</label>
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								<div class="">
									<label class="upload_photo"  for="vendorIncomeTaxFile">
										<img id="vendor_incometax_img_load" src="{{asset('images/default/photo.png')}}" ><i class="upload_hover ion ion-ios-camera-outline"></i>
									</label>
						...
						<div class="form-group row">
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
								...
								<div class="">
									{{Form::textarea('primary_item',$value=old('primary_item'),['class'=>'form-control','rows'=>3])}}
									<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
								...
								<div class="">
									{{Form::textarea('secondary_item',$value=old('secondary_item'),['class'=>'form-control','rows'=>3])}}
									<span class="text-danger">
						...
						<div class="form-group row">
							<div class="col-md-12">
								...
								<div class="">
									{{Form::textarea('supply_item_details',$value=old('supply_item_details'),['class'=>'form-control','rows'=>3])}}
									<span class="text-danger">
						...
						<div class="form-group row">
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 ">
								...
								<div class="">
									{{Form::textarea('office_address',$value=old('office_address'),['class'=>'form-control','rows'=>3])}}
									<span class="text-danger">
					  	{{$errors->has('office_address')?$errors->first('office_address'):''}}
							...
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
								...
								<div class="">
									{{Form::textarea('storage_address',$value=old('storage_address'),['class'=>'form-control','rows'=>3])}}
									<span class="text-danger">
					...
					<fieldset>
						...
						<div class="form-group row">
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								{{Form::number('mobile_1',$value=old('mobile_1'),['class'=>'form-control','required'=>true])}}
								<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								{{Form::number('mobile_2',$value=old('mobile_2'),['class'=>'form-control'])}}
								<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								<label>Fax</label>
								{{Form::text('fax',$value=old('fax'),['class'=>'form-control'])}}
								<span class="text-danger">
						...
						<div class="form-group row">
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								{{Form::email('email_1',$value=old('email_1'),['class'=>'form-control'])}}
								<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								{{Form::text('email_2',$value=old('email_2'),['class'=>'form-control'])}}
								<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								<label>Skype</label>
								{{Form::text('Skype',$value=old('Skype'),['class'=>'form-control'])}}
								<span class="text-danger">
						...
						<div class="form-group row">
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								{{Form::text('representative_name',$value=old('representative_name'),['class'=>'form-control'])}}
								<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								{{Form::text('representative_designation',$value=old('representative_designation'),['class'=>'form-control'])}}
								<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								{{Form::text('representative_mobile',$value=old('representative_mobile'),['class'=>'form-control'])}}
								<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								{{Form::text('representative_phone',$value=old('representative_phone'),['class'=>'form-control'])}}
								<span class="text-danger">
						...
						<div class="form-group row">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								{{Form::text('representative_email',$value=old('representative_email'),['class'=>'form-control'])}}
								<span class="text-danger">
							...
							<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
								...
								{{Form::text('representative_skype',$value=old('representative_skype'),['class'=>'form-control'])}}
								<span class="text-danger">
